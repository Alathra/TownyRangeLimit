...
public final class TownyRangeLimit extends JavaPlugin implements Listener {
            ...
            if (args[0].equalsIgnoreCase("/n") || args[0].equalsIgnoreCase("/nat") || args[0].equalsIgnoreCase("/nation")) {
                ...
                if (args[1].equalsIgnoreCase("merge")) {
                    if (!args[2].equalsIgnoreCase("deny") && !args[2].equalsIgnoreCase("accept")) {
                        ...
                        int dist = shortestDistance(nation1, nation2);
                ...
                //n invite
                    ...
                    if (!args[2].equalsIgnoreCase("deny") && !args[1].equalsIgnoreCase("accept")) {
                        ...
                        int dist = shortestDistance(town, nation);
            ...
            // t merge (wierd case lol)
                ...
                if (args[1].equalsIgnoreCase("merge")) {
                    if (!args[2].equalsIgnoreCase("deny") && !args[2].equalsIgnoreCase("accept")) {
                        ...
                        int dist = shortestDistance(town1, town2);
    ...
    private static int shortestDistance(Town town1, Town town2) {
        ...
        if (town1 != null && town2 != null) {
            try {
                ArrayList<WorldCoord> clusterInvited = getCluster(town1.getHomeBlock().getWorldCoord());
                ArrayList<WorldCoord> clusterInviter = getCluster(town2.getHomeBlock().getWorldCoord());
                WorldCoord invitedHomeblock = town1.getHomeBlock().getWorldCoord();
                WorldCoord inviterHomeblock = town2.getHomeBlock().getWorldCoord();
